        ...
        <table class="table table-bordered table-hover table-striped  ">
            ...
            @foreach($datos as $dato)
                ...
                <tr>
                    ...
                    <td class="text-center">{{$dato->$tipo_violencia}}</td>
                    <td class="text-center">{{$dato->$modalidad_violencia}}</td>
                    <td class="text-center">
                      <div class="d-inline-flex">
                          ...
                          @include('componentes.catalogos.clas_violencia.edit')
                      </div>
                          <div class="d-inline-flex">
